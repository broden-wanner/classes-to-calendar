      ...
      <Container className={classes.content}>
        <Card className={classes.card}>
          <CardContent>
            ...
            <p>
              Thank you for choosing to be part of our community (“Company”,
              ...
              <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link>. When
              you visit the website{" "}
              <Link href="classestocalendar.brodenwanner.com">
              ...
              of our Sites and our services.  This privacy notice applies to all
              information collected through our website (such as{" "}
              <Link href="classestocalendar.brodenwanner.com">
                classestocalendar.brodenwanner.com
              </Link>
              ), and/or any related services, sales, marketing or events (we
              refer to them collectively in this privacy notice as the
              "Services").   Please read this privacy notice carefully as it
              will help you make informed decisions about sharing your personal
              information with us.  
            </p>
            ...
            <p>
              We collect no information from any users. All data that is used to
              complete the service provided by the website for a specific user
              is not knowingly retained anywhere. That is the design of the
              website. The data that is used during use is only for the function
              of the app and that is all.
            </p>
            <Typography variant="h6" component="h6">
              2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?  
            </Typography>
            <p>
              In Short:  Your information will not be shared with anyone since
              we keep none of your information. If under any circumstance you
              find your information has been shared, please email{" "}
              <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link> or
              report it.
            </p>
            <Typography variant="h6" component="h6">
            ...
             
            <p>
              In Short:  We don't keep any of your information. All information
              pertaining to a user is destroyed after they leave the site.
            </p>
            <Typography variant="h6" component="h6">
            ...
            <p>
              ...
              information we process. No personal information is retained after
              use, and all that is transmitted during use is sent with
              encryption over HTTPS. However, please also remember that we
            ...
            <p>
              ...
              <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link>.
            </p>
            <Typography variant="h6" component="h6">
            ...
            <p>
              ...
              the data is not publicly displayed on the Services, but please be
            ...
            <p>
              ...
              an updated “Revised” date and the updated version will be
            ...
            <p>
              ...
              us at <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link>{" "}
              or by post to: Broden Wanner, 900 Washington Ave, Minneapolis, MN
              55455, United States
            </p>
          </CardContent>
        </Card>
