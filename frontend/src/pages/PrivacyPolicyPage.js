...
import { Card, CardContent, Typography, Container, makeStyles, Link, Grid } from "@material-ui/core";
        ...
        <Card className={classes.card}>
          <CardContent>
            <Grid container justifyContent="space-between">
              ...
              <PolicyIcon className={classes.icon}></PolicyIcon>
            </Grid>
            <Typography>Last updated August 15th, 2020</Typography>
            <p>
              Thank you for choosing to be part of our community (“Company”, “we”, “us”, or “our”). We are committed to
              protecting your personal information and your right to privacy. If you have any questions or concerns
              about our notice , or our practices with regards to your personal information, please contact us at{" "}
              <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link>. When you visit the website{" "}
              <Link href="classestocalendar.brodenwanner.com">classestocalendar.brodenwanner.com</Link>, and use our
              ...
              please discontinue use of our Sites and our services.  This privacy notice applies to all information
              collected through our website (such as{" "}
              <Link href="classestocalendar.brodenwanner.com">classestocalendar.brodenwanner.com</Link>
              ), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy
              notice as the "Services").   Please read this privacy notice carefully as it will help you make informed
            ...
            <p>
              We collect no information from any users. All data that is used to complete the service provided by the
              website for a specific user is not knowingly retained anywhere. That is the design of the website. The
              data that is used during use is only for the function of the app and that is all.
            </p>
            <Typography variant="h6" component="h6">
              2. WILL YOUR INFORMATION BE SHARED WITH ANYONE?  
            </Typography>
            <p>
              In Short:  Your information will not be shared with anyone since we keep none of your information. If
              under any circumstance you find your information has been shared, please email{" "}
              <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link> or report it.
            </p>
            <Typography variant="h6" component="h6">
            ...
             
            <p>
              In Short:  We don't keep any of your information. All information pertaining to a user is destroyed after
              they leave the site.
            </p>
            <Typography variant="h6" component="h6">
            ...
            <p>
              ...
              security measures.   We have implemented appropriate technical and organizational security measures
              designed to protect the security of any personal information we process. No personal information is
              retained after use, and all that is transmitted during use is sent with encryption over HTTPS. However,
              please also remember that we cannot guarantee that the internet itself is 100% secure. Although we will do
            ...
            <p>
              ...
              age 18, please contact us at <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link>.
            </p>
            <Typography variant="h6" component="h6">
            ...
            <p>
              ...
              your personal information. California Civil Code Section 1798.83, also known as the “Shine The Light” law,
              ...
              Services, you have the right to request removal of unwanted data that you publicly post on the Services.
            ...
              
            <p>
              In Short:  Yes, we will update this policy as necessary to stay compliant with relevant laws.   We may
            ...
            <p>
              ...
              <Link href="mailto:wanne036@umn.edu">wanne036@umn.edu</Link> or by post to: Broden Wanner, 900 Washington
              Ave, Minneapolis, MN 55455, United States
            </p>
          </CardContent>
        </Card>
      </Container>
